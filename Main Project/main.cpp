...
#include "LU factorization/lu_factorization.h"
...
#include "Matrix Inversion Method/matrix_inverse.h"
int main() {
    int choice;
    ...
    while (true) {
        ...
        switch (choice) {
            ...
            case 3: lu_factorization(); break;
            case 5: falseposition(); break;
            case 6: newton_raphson(); break;
            case 7: secant(); break;
            case 8: RK(); break;
            case 9: matrix_inverse(); break;
            case 0: cout << "Goodbye!\n"; return 0;
